...
class ShopdetailsController extends Controller {
	...
	public $module = 'shopdetails';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Shopdetails();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'shopdetails',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('shopdetails');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('shopdetails.public.view',$data);			
			}			
		} 
		else {
			...
			return view('shopdetails.public.index',$data);	
		}
