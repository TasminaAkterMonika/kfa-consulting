...
class ProjectdetailsController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('projectdetails');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('projectdetails.public.view',$data);			
			}			
		} 
		else {
			...
			return view('projectdetails.public.index',$data);	
		}
