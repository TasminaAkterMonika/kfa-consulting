...
class BlogdetailsController extends Controller {
	...
	public $module = 'blogdetails';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Blogdetails();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'blogdetails',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('blogdetails');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('blogdetails.public.view',$data);			
			}			
		} 
		else {
			...
			return view('blogdetails.public.index',$data);	
		}
