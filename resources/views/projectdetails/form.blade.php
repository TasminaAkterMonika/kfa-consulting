				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="image-preview preview-upload">
						 ...
						 >{{ $row['description'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Customer" class=" control-label col-md-4 text-left"> Customer </label>
										<div class="col-md-6">
										  <input  type='text' name='customer' id='customer' value='{{ $row['customer'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Live Demo" class=" control-label col-md-4 text-left"> Live Demo </label>
										<div class="col-md-6">
										  <input  type='text' name='live_demo' id='live_demo' value='{{ $row['live_demo'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
