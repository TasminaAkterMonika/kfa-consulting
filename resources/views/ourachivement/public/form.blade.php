		 ...
		 {!! Form::open(array('url'=>'ourachivement', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#status").jCombo("{!! url('ourachivement/comboselect?filter=status:id:title') !!}",
