                ...
                <div class="container">
                    <div class="clearfix">
                        <ul class="top-bar-text float_left">
                            <li><i class="fa fa-map-signs"></i>{!!$setting->address!!}</li>
                            ...
                            <ul>
                                <li class="single-info-box">
                                    ...
                                    <div class="text-holder">
                                        <p><span>Call Us Now</span><br>{!!$setting->phone!!}</p>
                                    </div>
                                </li>
                                <li class="single-info-box">
                                    <div class="icon-holder">
                                    ...
                                    <div class="text-holder">
                                        <p><span>Send Mail Us</span> <br>{!!$setting->email!!}</p>
                                    </div>
                                </li>
                                <li class="link_btn">
                            ...
                            <nav class="main-menu">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        {{-- <li class="dropdown"><a href="{{route('shops')}}">SHOP</a> --}}
                                            {{-- <ul class="submenu">
